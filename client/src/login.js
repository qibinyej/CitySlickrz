...
function Login() {
        ...
        return (
                <div id="login-parent">
                        {signUp && <Signup signUp={signUp} closeSignUp ={setSignUp}/>}
                        ...
                        <div id="login-credentials-div">
                                ...
                                <h3 id="header">Don't have a profile? <strong onClick={() => {setSignUp(true)}} style={{ color: 'blue', cursor: 'pointer' }}>Sign Up</strong> </h3>
                                <form>
